package com.quran.app.utils.univ;

import static android.content.Intent.FLAG_GRANT_READ_URI_PERMISSION;
import static com.quran.app.utils.reader.TranslUtils.TRANSL_AVAILABLE_DOWNLOADS_FILE_NAME;
import static com.quran.app.utils.reader.recitation.RecitationUtils.AVAILABLE_RECITATIONS_FILENAME;
import static com.quran.app.utils.reader.recitation.RecitationUtils.AVAILABLE_RECITATION_TRANSLATIONS_FILENAME;
...
import com.quran.app.utils.chapterInfo.ChapterInfoUtils;
...
import com.quran.app.utils.tafsir.TafsirUtils;
...
public final class FileUtils {
    ...
    public boolean createFile(File file) {
        ...
        try {
            ...
            Log.e("FileUtils", "Failed to create file: " + file.getAbsolutePath(), e);
        }
        return false;
    }
    ...
    public String readText(@NonNull File file) throws IOException {
        try (FileInputStream fis = new FileInputStream(file)) {
            return StringUtils.readInputStream(fis);
        }
    }
    ...
    public void cloneDirectory(@NonNull File sourceLoc, @NonNull File targetLoc) throws IOException {
        if (sourceLoc.isDirectory()) {
            ...
            try (InputStream in = new FileInputStream(sourceLoc);
    ...
    public String getPathFromUri(@NonNull Uri uri) {
        try {
            ...
            Log.e("FileUtils", "Error getting path from Uri: " + uri, e);
            return null;
        }
    }
}
