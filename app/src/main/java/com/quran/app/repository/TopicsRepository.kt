package com.quran.app.repository

import android.content.Context
import com.quran.app.compose.utils.preferences.ReaderPreferences
import com.quran.app.db.TopicsDatabase
...
class TopicsRepository(
    ...
    private fun List<com.quran.app.db.relations.topics.TopicVerseRow>.toVerseRefs(): List<String> {
