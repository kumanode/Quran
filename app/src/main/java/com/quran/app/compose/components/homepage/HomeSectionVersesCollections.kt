...
import com.quran.app.activities.reference.ActivityDhikrDua
import com.quran.app.activities.reference.ActivityExclusiveVerses
import com.quran.app.activities.reference.ActivityProphets
import com.quran.app.activities.reference.ActivityQuranScience
import com.quran.app.activities.reference.ActivityQuranicTopics
import com.quran.app.compose.screens.quranictopics.QuranicTopicsStart
...
fun HomeSectionVersesCollections() {
    ...
    val appLocale = com.quran.app.compose.utils.LocalAppLocale.current
    ...
    val entries = remember(appLocale) {
        listOf(
            ...
            VersesCollectionCard(
                R.string.titleDzikirDoa,
                R.drawable.ic_tasbih,
            ) {
                context.startActivity(
                    Intent(context, ActivityDhikrDua::class.java)
                )
            },
        )
    }
