...
import com.quran.app.compose.components.reader.navigator.ReaderFooterNavigator
...
import com.quran.app.utils.reader.MUSHAF_FONT_WIDTH_DP_MAX
import com.quran.app.utils.reader.atlas.AtlasGlyphPlacement
import com.quran.app.viewModels.ReaderUiState
    ...
    TextStyleProvider(prepared.textStyles) {
        LazyColumn(
            ...
            items(
                ...
                val isBookmarked = remember(item, bookmarkedVerseKeys) {
                ...
                TranslationRow(readerVm, item, isBookmarked)
            }
